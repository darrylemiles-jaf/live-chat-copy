  ...
  return (
    ...
    >
      ...
      <Box sx={{ px: 2, pb: 2, pt: 0 }}>
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}>
          ...
          {!isFirst && selected && (
            ...
            >
              Only the first customer in queue can be assigned
            </Typography>
          )}
        </Stack>
      </Box>
      ...
      <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)}>
        <DialogTitle>Assign First Chat in Queue</DialogTitle>
        <DialogContent>
          <DialogContentText>
            You are about to open the first chat in the queue. This chat will be assigned to you and you will be marked as busy. Continue?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
